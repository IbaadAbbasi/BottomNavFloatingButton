...
//    var unSelectedColor = Color.parseColor("#8F8F8F")
    var unSelectedColor = Color.parseColor("#006633")
        set(value) {
            field = value
            if (isMenuInitialized) {
                updateMenuIconsTint()
    ...
    var fabBackgroundColor = Color.parseColor("#FF6600")
        set(value) {
            field = value
    ...
    var navBackgroundColor = Color.parseColor("#C2C5C1")
        set(value) {
            field = value
    ...
    private fun navigateToDestination(navController: NavController, itemCbn: CbnMenuItem) {
        ...
        val builder = NavOptions.Builder()
            ...
            .setPopEnterAnim(androidx.navigation.ui.ktx.R.anim.nav_default_pop_enter_anim)
    ...
    private fun initializeBottomItems(activeItem: Int) {
        ...
        context.theme.resolveAttribute(androidx.navigation.ui.R.attr.selectableItemBackground, typedValue, true)
