...
import com.railway.ncs.databinding.FragmentPrintReceiptBinding
import com.railway.ncs.printpkg.util.PrintUtils.printImage


class PrintReceiptFragment : Fragment() {
    lateinit var binding:FragmentPrintReceiptBinding
    ...
    private fun clickListener() {
        ...
        binding.txtPrint.setOnClickListener {
            //printing...

            ((activity) as MainActivity).printImageMain()
            findNavController().navigate(R.id.action_printReceiptFragment_to_reprintFragment)
        }
